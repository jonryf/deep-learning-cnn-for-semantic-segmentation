...
class WNET(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.deconv3 = nn.ConvTranspose2d(128, 256, kernel_size=2, stride=2, padding=0, output_padding=0)
        
        self.conv4_1   = nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1 )
        self.conv4_2   = nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1 )
        self.deconv4 = nn.ConvTranspose2d(384, 128, kernel_size=2, stride=2, padding=0, output_padding=0)
        
        
        self.conv5_1   = nn.Conv2d(192, 64, kernel_size=3, stride=1, padding=1)
        ...
        self.conv6_1   = nn.Conv2d(448, 128, kernel_size=3, stride=1, padding=1 )
        ...
        self.deconv7 = nn.ConvTranspose2d(256, 256, kernel_size=2, stride=2, padding=0, output_padding=0)

        self.conv8_1   = nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1 )
        self.conv8_2   = nn.Conv2d(384, 384, kernel_size=3, stride=1, padding=1 )
        self.deconv8 = nn.ConvTranspose2d(384, 128, kernel_size=2, stride=2, padding=0, output_padding=0)
        
        self.conv9_1   = nn.Conv2d(192, 64, kernel_size=3, stride=1, padding=1 )
